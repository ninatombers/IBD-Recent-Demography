...
data_pic<-list.files(path = "/Users/brigittetombers/Desktop/DistancesR/R/PhasedIBD", pattern = "*.png",recursive = FALSE)
...
#--- Diplodus graph
    ...
    ggsave(filename = "plot_H_puella_ses_phasedIBD_300_02.pdf", plot = plot_H_puella_ses)
    ggsave(filename = "plot_H_puella_slope_phasedIBD_300_02.pdf", plot = plot_H_puella_slope)       
